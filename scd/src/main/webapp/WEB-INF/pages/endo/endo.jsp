...
<body class="home">
	...
	<div class="col-sm-7">
		...
		<form:form commandName="endoSearch" method="post" action="endo"
			...
			<form:input cssClass="form-control" path="pacienteToSearch"
				placeHolder="${mainPlaceHolder}" id="pacienteToSearch" />
	...
	<div>
		<display:table name="pacienteList" cellspacing="0" cellpadding="0"
			requestURI="" defaultsort="1" id="pacienteList" pagesize="25"
			class="table table-condensed table-striped table-hover" export="true">
			<display:column property="nombre" escapeXml="true" sortable="true"
				titleKey="active.momentodia" style="width: 25%" />
			<display:column property="apellido" escapeXml="true" sortable="true"
				titleKey="activeUsers.alimentosrecomendados" style="width: 34%" />
		</display:table>
	</div>
	</form:form>
