...
<div class="col-sm-7">
    ...
    <form:form commandName="unMedicamento" method="post" action="medicamentoList" id="userForm" autocomplete="off"
        ...
        <div class="form-group">
			...
			<!-- Aca debo ver como soluciono para que me muestre,para borrar -->
