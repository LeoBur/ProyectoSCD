...
<div class="col-md-9">
	...
	<form:form commandName="endocrinologoForm" method="post" action="editProfile" id="formulario" autocomplete="off"
  		...
  		<spring:bind path="dni">
                ...
                <spring:bind path="password">
                                	<input type="hidden" name="password" id="password" class="form-control" value="${status.value}"/>
                                </spring:bind>
                                <spring:bind path="confirmPassword">
                                                	<input type="hidden" name="confirmPassword" id="confirmPassword" class="form-control" value="${status.value}"/>
                                                </spring:bind>
