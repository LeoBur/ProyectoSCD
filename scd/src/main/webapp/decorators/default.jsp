...
<head>
    ...
    <link rel="stylesheet" href="${ctx}/webjars/bootstrap/1.0/css/bootstrap.min.css">
    <link rel="stylesheet" href="${ctx}/styles/app.css">
    <script type="text/javascript" src="${ctx}/webjars/jquery/1.8.2/jquery.min.js"></script>
    <script type="text/javascript" src="${ctx}/webjars/bootstrap/1.0/js/bootstrap.min.js"></script>
