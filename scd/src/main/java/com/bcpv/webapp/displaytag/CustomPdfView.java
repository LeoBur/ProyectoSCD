package com.bcpv.webapp.displaytag;
...
public class CustomPdfView extends PdfView {
     ...
     * @throws com.lowagie.text.BadElementException for errors during table initialization
     */
    ...
    public void doExport(OutputStream out) throws JspException
    {
        try
        {
            ...
            //sheet.createRow(rowNum++).createCell(0).setCellValue(model.getCaption());
            ...
            generatePDFTable();
            document.open();
            this.writeCaption(model, document);
     ...
     */
    protected void writeCaption(TableModel model, Document document) throws Exception
    {
        this.decorateCaption(model, document);
    }

    /**
     * Writes the table caption according to a set style.
     * @param model The table model containing the caption.
     * @throws com.lowagie.text.DocumentException If an error occurrs while decorating the caption.
     */
    private void decorateCaption(TableModel model, Document document) throws DocumentException
    {
