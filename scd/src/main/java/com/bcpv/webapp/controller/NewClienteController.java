 ...
 */
@Controller
@RequestMapping("/admin/newCliente*")
public class NewClienteController extends BaseFormController {
    ...
    public NewClienteController() {
        setCancelView("redirect:/home");
        setSuccessView("redirect:/clienteForm");
    }
