...
public class PersistentPasswordTokenManagerImpl implements PasswordTokenManager {
    ...
    /**
     * @see com.dptosweb.service.impl.PasswordTokenManager#generateRecoveryToken(com.dptosweb.model.User)
     */
    @Override
    ...
    /**
     * @see com.dptosweb.service.impl.PasswordTokenManager#isRecoveryTokenValid(com.dptosweb.model.User, java.lang.String)
     */
    @Override
    ...
    /**
     * 
     * @see com.dptosweb.service.impl.PasswordTokenManager#invalidateRecoveryToken(User, String)
     */
    @Override
