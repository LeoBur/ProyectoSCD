...
import war.webapp.service.TipoDiabetesManager;
import war.webapp.service.TipoDiabetesService;

@Service("tipoDiabetesManager")
@WebService(serviceName = "TipoDiabetesService", endpointInterface = "war.webapp.service.TipoDiabetesService")
