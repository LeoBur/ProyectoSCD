...
import war.webapp.service.LocalidadManager;
import war.webapp.service.LocalidadService;

@Service("localidadManager")
@WebService(serviceName = "LocalidadService", endpointInterface = "war.webapp.service.LocalidadService")
